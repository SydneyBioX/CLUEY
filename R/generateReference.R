...
#'
#' @description
#' Generate pseudobulked reference for cluster estimation performed in runCLUEY
#'
#' @param reference A numeric matrix of normalised gene expression data where rows are
...
#' passed to `reference`. Default is NULL.
...
#' Default is 20 cells.
#' @return A named list containing pseudobulked expression profiles for each cell-type provided in reference.
#' @export
#'
generateReference <- function(reference, celltypes, batch = NULL, method = "ds", minCells = 20){
